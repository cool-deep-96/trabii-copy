    ...
    <div className="w-full flex justify-center bg-black">
      <div className="relative max-w-[355px] w-full lg:max-w-screen-lg px-5 pt-10 lg:pt-20 lg:pl-40 pb-32  flex items-start  ">
        <img
          src={smile}
          alt="smile.png"
          className="absolute h-[40%] lg:h-[65%]  w-auto opacity-30 bottom-40 lg:bottom-24 right-5"
        />
        <p className="relative lg:w-[50%] text-3xl lg:text-4xl font-bold text-white">
