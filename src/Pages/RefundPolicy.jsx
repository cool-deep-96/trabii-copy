    ...
    <div className="w-full flex justify-center py-3">
      <div className="max-w-[355px] lg:max-w-screen-xl">
        <div  className="max-w-screen-xl  w-full"
          ...
          <p>Thank you for shopping at TraBii.</p>{" "}
          <p>
          ...
          <h2>Interpretation and Definitions</h2> <h3>Interpretation</h3>{" "}
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to TRABII
                ENTERTAINMENT PRIVATE LIMITED, 158, Vikash Colony, BAG - 1 Pakka
                Bag, Etawah, Etawah, Etawah- 206001, Uttar Pradesh.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              <p>By email: support@trabii.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:{" "}
                <a
                  href="https://www.trabii.com/contact-us"
                ...
                >
                  https://www.trabii.com/contact-us
                </a>
              </p>
            </li>
            <li>
              <p>By phone number: +919971855077</p>
            </li>
          </ul>{" "}
          <p>
          ...
          <p>
            Customers should send refund requests via email to
            support@trabii.com within 30 days of the event or service
            completion. If additional documentation or proof is required, our
            support team will provide further instructions. Please note that
            physical products (if applicable) should be returned to our
            headquarters at 158, Vikash Colony, BAG - 1 Pakka Bag, Etawah,
            Etawah, Etawah- 206001, Uttar Pradesh within 30 days of receiving
            them, in original condition, to qualify for a refund.
          </p>{" "}
          <p>
