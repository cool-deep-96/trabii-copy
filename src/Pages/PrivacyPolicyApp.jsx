  ...
  return (
    <div className="w-full flex justify-center py-5">
      <div className="max-w-[355px] lg:max-w-screen-xl">
        ...
        >
          <h1>Privacy Policy</h1> <p>Last updated: September 28, 2024</p>{" "}
          <p>
          ...
          <h3>Definitions</h3> <p>For the purposes of this Privacy Policy:</p>{" "}
          <ul>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to TraBii, the software
          ...
          <h3>Types of Data Collected</h3> <h4>Personal Data</h4>{" "}
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                <a
                  href="https://trabii.com/contact-us"
                ...
                >
                  https://trabii.com/contact-us
                </a>
              </p>
            </li>
            <li>
              <p>By phone number: +918069640218</p>
            </li>
          </ul>
        </div>
      </div>
